...
```bash
# 1. Clone this repo
git clone https://github.com/Visual-Hive/eventhive-tool-briefing-generator.git
cd eventhive-tool-briefing-generator
...
| `TOOL_TITLE` | `Briefing Generator` | Title shown inside the tool |
